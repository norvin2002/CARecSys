...
eval <- evaluationScheme(wine_cf_rrm, method = 'split', train = 0.8, given = 10, goodRating = 50)
...
IBCF_N_N <- Recommender(getData(eval, 'train'), 'IBCF', parameter = list(normalize = NULL, method = "Cosine", k = 100))
